    ...
    return (
        <div className='bg-[#edeff1]'>
            <div className="grid grid-cols-4 items-baseline gap-4 py-8">
                ...
                <div className="flex flex-col items-center">
                    <img src="/images/footer/telegram.png" alt="telegram" className="w-16 h-16 mb-2" />
                    <span className="text-center">کانال تلگرام مخصوص عمده فروشان همکار</span>
                </div>
                <div className="flex flex-col items-center">
            ...
            <div className='grid grid-cols-5 place-items-center py-8 px-6 text-[18px]'>
                <div className=' h-24 flex '><span>تماس با ما</span></div>
                <div className=' h-24 flex items-end'><span>شکایات</span></div>
                <div className=' h-24 flex '><span>درباره ما</span></div>
                <div className=' h-24 flex items-end'><span>قوانین و مقررات</span></div>
                <div className=' h-24 flex '><span>سیاست حریم خصوصی</span></div>
            </div>
            <hr className='text-gray-300 ' />
            <div className='flex justify-between px-10 py-4'><span>هفت روز هفته ، از ساعت 1 ظهر تا 12 شب پاسخگوی شما هستیم</span><span>شماره تماس 09052936399</span></div>
            ...
            <div className=' pt-6 bg-[#d8dee0]'>
                <div className='pr-10'>
                    ...
                    <div className='flex gap-x-2 justify-center pt-12'>
                ...
                <hr className='my-4' />
                <span className='text-center block'>استفاده از مطالب فروشگاه گالری ایلیا فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است. کلیه حقوق این سایت محفوظ می‌باشد.</span>
            </div>
        </div >
    )
}
